      ...
      <div className="max-w-4xl mx-auto space-y-4">
            ...
            <div className="relative space-y-1">
              <h1 className="text-2xl md:text-3xl font-bold">
                <div className="mb-1 text-gray-800">
                  How Many Clients Is Your Clinic Losing
                </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-4">
          <div className="bg-orange-50 p-3 rounded-xl text-center">
            ...
            <h3 className="font-bold mb-1 text-sm">Advanced AI Technologies</h3>
            <p className="text-gray-600 text-xs">Latest technologies for procedure analysis and planning</p>
          </div>
          
          <div className="bg-orange-50 p-3 rounded-xl text-center">
            <Users className="w-8 h-8 mx-auto text-[#FF8A3D] mb-2" />
            <h3 className="font-bold mb-1 text-sm">Convert Hesitant to Clients</h3>
            <p className="text-gray-600 text-xs">Innovative solutions for building client trust</p>
          </div>

          <div className="bg-orange-50 p-3 rounded-xl text-center">
            <Camera className="w-8 h-8 mx-auto text-[#FF8A3D] mb-2" />
            <h3 className="font-bold mb-1 text-sm">Specialized Technology</h3>
            <p className="text-gray-600 text-xs">Expert experience in hair transplantation</p>
          </div>
        </div>
