      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {[
            {
              icon: Users,
              text: "Over 100 premium clinics are using our tool today",
              gradient: "from-orange-400 to-amber-300"
            },
            {
              icon: TrendingUp,
              text: "70% of hesitant clients converted to confirmed bookings",
              gradient: "from-amber-400 to-orange-300"
            },
            {
              icon: Clock,
              text: "14 days free trial to test the results yourself",
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-orange-100 mb-24
          ...
          <div className="space-y-6">
            {[
              ...
              "See the results in your clinic firsthand",
              "If you're not satisfied... pay nothing"
            ].map((text, index) => (
              <div 
                key={index}
        ...
        <div className="text-center mb-24 transform hover:scale-105 transition-transform duration-300">
          ...
          <p className="text-2xl text-gray-700 animate-pulse">
            How many clients will you lose while your competitors are using the tool?
          </p>
        </div>
        ...
        <div className="text-center relative">
          ...
          <div className="mt-12 flex justify-center items-center space-x-6">
            {['No Credit Card Required', 'Cancel Anytime', 'Continuous Support'].map((text, index) => (
