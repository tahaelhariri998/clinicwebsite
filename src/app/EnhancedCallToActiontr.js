      ...
      <div className="max-w-4xl mx-auto relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
          {[
            {
              icon: Users,
              text: "100'den fazla premium klinik şu anda aracımızı kullanıyor",
              gradient: "from-orange-400 to-amber-300"
            },
            {
              icon: TrendingUp,
              text: "Kararsız hastaların %70'i kesin randevuya dönüştü",
              gradient: "from-amber-400 to-orange-300"
            },
            {
              icon: Clock,
              text: "Sonuçları kendiniz test etmek için 14 gün ücretsiz deneme",
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-orange-100 mb-24
          ...
          <div className="space-y-6">
            {[
              ...
              "Sonuçları kliniğinizde bizzat görün",
              "Memnun kalmazsanız... hiçbir ücret ödemeyin"
            ].map((text, index) => (
              <div 
                key={index}
                className="group flex items-center space-x-4 p-6 rounded-xl
        ...
        <div className="text-center mb-24 transform hover:scale-105 transition-transform duration-300">
          ...
          <p className="text-2xl text-gray-700 animate-pulse">
            Rakipleriniz bu aracı kullanırken kaç hasta kaybedeceksiniz?
          </p>
        </div>
        ...
        <div className="text-center relative">
          ...
          <div className="mt-12 flex justify-center items-center space-x-6">
            {['Kredi Kartı Gerekmez', 'İstediğiniz Zaman İptal Edin', 'Sürekli Destek'].map((text, index) => (
