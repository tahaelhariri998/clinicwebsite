      ...
      <main className="bg-gray-100 text-gray-800 font-sans leading-relaxed">
        ...
        <section className="py-12">
          <div className="container mx-auto px-6 lg:px-20">
            ...
            <p className="text-lg mb-6">إذا كانت لديكم أي أسئلة أو مخاوف بخصوص سياسة الخصوصية هذه، يرجى الاتصال بنا عبر البريد الإلكتروني <a href="mailto:info@nextgraft.com" className="text-[#FF9500]">info@nextgraft.com</a>.</p>
          </div>
        </section>
