  ...
  const steps = [
    {
      ...
      description: "One photo opens the door to transformation",
    ...
    },
    {
      ...
      description: "AI precisely analyzes your features",
    ...
    },
    {
      Icon: Sparkles,
      title: "See Results",
      description: "View your new look in 60 seconds",
    ...
    },
    {
      ...
      description: "Make confident decisions and book instantly",
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-orange-50 py-16 px-4">
      ...
      <div className="max-w-5xl mx-auto mb-24">
        <h2 className="text-3xl md:text-4xl font-bold text-center mb-16 text-gray-800">
          Real Results from Clinics Using Our Technology
        </h2>
        ...
        <div className="relative">
          ...
          <div className="relative bg-white rounded-2xl p-12 shadow-2xl border border-orange-200">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">
              Ready to Experience AI Power in Your Clinic?
            </h2>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Start today and see how our technology transforms hesitant prospects into confident clients
            </p>
